...
class CounselTest {
	...
	/*
	 * @Test void insertCounsel() { counselRep.save(new Counsel(null, new
	 * Member(4L), new Counselor(1L), 3, 1, new Date())); }
	 * 
	 * @Test void insertRequest() { requestRep.save(new Requests(null, new
	 * Counsel(2L), "제목제목", 3, "내용내용내용")); }
	 * 
	 * @Test void insertRequestAns() { requestAnsRep.save(new RequestAns(null, new
	 * Requests(1L), new Counselor(1L), "답변드립니다.")); }
	 */
