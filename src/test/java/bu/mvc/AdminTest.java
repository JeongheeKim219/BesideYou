...
public class AdminTest {
	...
	/*
	 * @Test void test_13() { int randomTry = (int) (Math.random() * 50);
	 * 
	 ...
	 * 
	 * double randomStars = Math.round((Math.random() * 5)) + 1; Counsel
	 * randonCounsel = counselList.get(i); LocalDateTime reviewDate =
	 * randonCounsel.getCounselDate().plusDays(4);
	 * 
	 * reviewRep.save(new ReviewStar(null, randonCounsel.getMember(),
	 * randonCounsel.getCounselor(), randonCounsel, reviewDate,randomStars, null));
	 * }
	 * 
	 * }
	 */
