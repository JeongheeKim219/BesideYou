...
<meta name="theme-color" content="#ffffff">
	...
	<table style="width: 600px; border-bottom-width: 1px;" >
		<tr>
			<td width="100">ID : </td>
			<td>${requestScope.searchId}</td>
		</tr>
		
	</table><br>
	<a class="btn btn-outline-primary" href="${pageContext.request.contextPath}/member/passCheckForm">비밀번호 찾기</a>
	<a class="btn btn-outline-primary"  href="${pageContext.request.contextPath}/member/login">로그인하러 가기</a>
                        </div>
                    </div>
                    <!--/.row-->
                </div>
