	...
	<c:forEach items="${requestScope.list}" var="list"> <!-- pageList.getContent() -->
		    <tr onmouseover="this.style.background='#eaeaea'" onmouseout="this.style.background='white'">
		        <td bgcolor="">
		            ...
		            ${list.noticeCode}</span></p>
		        </td>
		        <td bgcolor="">
					<p><span style="font-size:9pt;">
					<a href="${pageContext.request.contextPath}/notice/read/${list.noticeCode}"> ${list.noticeTitle}</a></span></p>
		        </td>
		        <td bgcolor="">
		            <p align="center"><span style="font-size:9pt;">
		            작성자입니다.</span></p>
		        ...
		        <td bgcolor="">
		            <p align="center"><span style="font-size:9pt;">
		            ${list.noticeDate}</span></p>
		        </td>
		        <td bgcolor="">
		            <p align="center"><span style="font-size:9pt;">
		            ${list.noticeNum}</span></p>
		        </td>
		    </tr>
    </c:forEach>
	</c:otherwise>
...
<div align=right>
<span style="font-size:9pt;">&lt;<a href="${pageContext.request.contextPath}/notice/write">글쓰기</a>&gt;</span></div>
