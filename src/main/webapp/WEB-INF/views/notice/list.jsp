...
a {
	...
	<section class="background-11" style="padding-top: 70px !important">
		<div class="container">
			<h3 class="text-center fs-2 fs-md-3">공지사항</h3>
			<hr class="short"
					...
					<c:otherwise>
						<c:forEach items="${requestScope.list}" var="list">
							...
							<tr onmouseover="this.style.background='#eaeaea'"
								...
								<td bgcolor="">
									<p align="center">
										<span style="font-size: 9pt;"> ${list.noticeCode}</span>
									</p>
								</td>
								<td bgcolor="">
									<p>
										<span style="font-size: 9pt;"> <a
											href="${pageContext.request.contextPath}/notice/read/${list.noticeCode}">
												${list.noticeTitle}</a></span>
									</p>
								</td>
								<td bgcolor="">
									<p align="center">
										<span style="font-size: 9pt;"> 관리자 </span>
									</p>
								</td>
								<td bgcolor="">
									<p align="center">
										<span style="font-size: 9pt;"> ${list.noticeDate}</span>
									</p>
								</td>
								<td bgcolor="">
									<p align="center">
										<span style="font-size: 9pt;"> ${list.noticeNum}</span>
									</p>
								</td>
							</tr>
						</c:forEach>
			...
			<sec:authorize access="hasRole('ROLE_ADMIN')">
				<div align=right style="padding-top: 20px">
					<span style="font-size: 9pt;"><a
						href="${pageContext.request.contextPath}/notice/write"
