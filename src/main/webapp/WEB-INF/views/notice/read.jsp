		...
		$("#update")
				.click(
						function() {
							...
							$("#requestForm")
									.attr("action",
											"${pageContext.request.contextPath}/notice/updateForm");
							$("#requestForm").submit();
						})
...
<section class="background-11" style="padding-top: 70px !important">
	<div class="container">
		<h3 class="text-center fs-2 fs-md-3">공지사항 자세히 보기</h3>
		<hr class="short"
		...
		<div class="col-12 mt-4">
			<div class="background-white p-5 h-100 radius-secondary">
				...
				<form id="requestForm" method="get">
					<input type="hidden" name="${_csrf.parameterName}"
						value="${_csrf.token}" /> <input type=hidden name="noticeCode"
						value="${notice.noticeCode}">
					<div class="row">
						<div class="col-12">
							<input class="form-control background-white" type="text"
								value="${requestScope.notice.noticeTitle}" readonly="readonly">
						</div>
						<div class="col-12 mt-4">
							<input class="form-control background-white" type="text"
								value="${requestScope.notice.noticeDate}" readonly="readonly">
						</div>
						<div class="col-12 mt-4">
							<textarea class="form-control background-white" rows="11"
								readonly="readonly">${requestScope.notice.noticeContent}</textarea>
						</div>
