...
<BODY>
	...
	<section class="background-11" style="padding-top: 70px !important">
		<div class="container">
			<h3 class="text-center fs-2 fs-md-3">공지사항 수정하기</h3>
			<hr class="short"
			...
			<div class="col-12 mt-4">
				<div class="background-white p-5 h-100 radius-secondary">
					<h5>${notice.noticeCode}번 공지사항 수정하기</h5>
						...
						<div class="row">
							<div class="col-12">
								<input class="form-control background-white" type="text"
									name="noticeTitle" value="${requestScope.notice.noticeTitle}">
							</div>
							<div class="col-12 mt-4">
								<textarea class="form-control background-white" rows="11"
									name="noticeContent">${requestScope.notice.noticeContent}</textarea>
							</div>
							<div class="col-12 mt-4">
								<div class="row">
									<div class="col-auto">
