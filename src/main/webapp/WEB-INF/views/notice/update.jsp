...
<form name=updateForm method=post action="${pageContext.request.contextPath}/notice/update" >
    <input type='hidden' name='noticeCode' value="${notice.noticeCode}">
	<table align="center" cellpadding="5" cellspacing="1" width="600" border="1">
    <tr>
        <td width="1220" height="20" colspan="2" bgcolor="#3680B3">
            <p align="center"><font color="white" size="3"><b> ${notice.noticeCode} 공지사항 수정하기</b></font></p>
        </td>
    </tr>
    <tr>
