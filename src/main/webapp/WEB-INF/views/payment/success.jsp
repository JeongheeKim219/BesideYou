                ...
                <div class="container">
                    <div class="row h-full align-items-center">
                        ...
                        <div data-zanim-timeline="{}" data-zanim-trigger="scroll">
                            ...
                            <div class="mt-3" data-zanim='{"delay":0.1}'><h3>"결제가 완료되었습니다."</h3></div><br>
                            <div class="mt-3" data-zanim='{"delay":0.3}'>
                            <a class="btn btn-outline-primary btn-sm" href="${pageContext.request.contextPath}/">BU home</a><br></div>
                            <%-- <c:if test="${couselCategory==0}">
                            	<a class="btn btn-outline-primary btn-sm" href="${pageContext.request.contextPath}/counsel/apply?counselorCode=${counselorCode}&couselCategory=0">상담사 페이지로</a><br></div>
                            </c:if>
                            <c:if test="${couselCategory!=0}">
                            	<a class="btn btn-outline-primary btn-sm" href="${pageContext.request.contextPath}/counsel/apply?counselorCode=${counselorCode}&couselCategory=${couselCategory}">상담사 페이지로</a><br></div>
                            </c:if> --%>
							<%-- \${counselorCode} = ${counselorCode}
							\${couselCategory} = ${couselCategory} --%>
							</div>
							</div>
                        </div>
                    </div>
