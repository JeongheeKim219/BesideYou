										...
										<div class="col-12">
											<div class="row mt-6">
												<div class="col-12">
													<div
														class="background-white p-5 radius-bl-secondary radius-br-secondary">
														<h4 data-zanim='{"delay":0.1}'>${art.member.alias}님에게
															답변 등록하기</h4>
														<form class="mt-4" name="inForm" method="post" id="inForm"
															action="${pageContext.request.contextPath}/psy/lo/write">
															<input type="hidden" name="${_csrf.parameterName}"
																value="${_csrf.token}"> <input type="hidden"
																name="artCode" value="${art.artCode}">
															<div class="row">
																<div class="col-12">
																	<h5 data-zanim='{"delay":0.1}'>답변을 등록해주세요.</h5>
																	<p>1300자 이내로 작성해주세요.</p>
																	<textarea name="artAnsContent" id="artAnsContent"
																		class="form-control background-white" rows="10"
																		placeholder="ex) 파일을 확인한 후에 답변을 등록해주세요."
