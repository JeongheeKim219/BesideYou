		...
		<section class="background-11 text-center">
			<div class="container">
				<div class="row text-center">
					<div class="col">
						<h3 class="fs-2 fs-md-3 fw-600">Self Test</h3>
						<hr class="short"
				...
				<div class="row mt-5">
					<div class="col-sm-6 col-lg-4">
						<div class="background-white pb-4 h-100 radius-secondary">
							<img class="mb-4 radius-tr-secondary radius-tl-secondary"
								src="/assets/images/psy/dep.jpg" alt="Depression Img"
								id="testImg" />
							<div class="px-4" data-zanim-timeline="{}"
								...
								<div class="overflow-hidden">
									<p class="py-3 mb-0" data-zanim='{"delay":0.2}'>우울증 자가진단
										테스트!
									<p>나의 우울증 지수는 몇 점일까?</p>
								</div>

								<div class="overflow-hidden">
									<a href="#" class="btn btn-outline-primary" id="startlogin"
										onclick="depressionCheck()">START</a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-lg-4">
						<div class="background-white pb-4 h-100 radius-secondary">
							<img class="mb-4 radius-tr-secondary radius-tl-secondary"
								src="/assets/images/psy/stress.jpg" alt="Stress Img"
								id="testImg" />
							<div class="px-4" data-zanim-timeline="{}"
								data-zanim-trigger="scroll">
								<div class="overflow-hidden">
								...
								<div class="overflow-hidden">
									<p class="py-3 mb-0" data-zanim='{"delay":0.2}'>스트레스 자가진단
										테스트!
									<p>나의 스트레스 지수는 몇 점일까?</p>
								</div>
								<div class="overflow-hidden">
									<a href="#" class="btn btn-outline-primary" id="startlogin"
										onclick="stressCheck()">START</a>
								</div>
							</div>
						</div>
					</div>
