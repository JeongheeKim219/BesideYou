                                        ...
                                        <div class="col-12">
                                            <div class="background-white p-5 radius-bl-secondary radius-br-secondary">
                                                ...
                                                <form class="mt-4" name="inForm" method="post" id="inForm" action="${pageContext.request.contextPath}/psy/signup">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <h5 data-zanim='{"delay":0.1}'>사전 지시사항을 입력해주세요.</h5>
                                                            <p>1000자 이내로 작성해주세요.</p>
                                                            <textarea name="question" class="form-control background-white" rows="10" placeholder="ex) 제한시간은 3분이내입니다. 오래 생각하지 말고 그려주세요." aria-label="Text input with dropdown button"></textarea>
                                                        </div>
                                                        <div class="col-12 mt-4">
                                                        	<h5 data-zanim='{"delay":0.1}'>검사항목을 입력해주세요.</h5>
                                                        	<p>1000자 이내로 작성해주세요.</p>
                                                            <textarea name="detail" class="form-control background-white" rows="10" placeholder="ex) 1. 비오는 날 그림을 그려주세요. 2. 나무를 그려주세요." aria-label="Text input with dropdown button"></textarea>
                                                        </div>
                                                        <div class="col-12 mt-4">
