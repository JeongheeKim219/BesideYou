	...
	<main>
      ...
      <div class="znav-white znav-container sticky-top navbar-elixir"
		...
		<section>
			<div class="container">
				<div class="row">
					<div class="col-lg-12 pr-0 pr-lg-3" style="text-align: center;">
						<img class="radius-secondary" src="/assets/images/psy/art.jpg"
							alt="art main" />
					</div>
				</div>
				<!--/.row-->
				<div class="row text-center mb-3">
					<div class="col">
						<h3 class="fs-2 fs-md-3 fw-600">나의 심리 상태는? 그림 검사로 알아보기</h3>
						<hr class="short"
				...
				<div
					...
					<h5 data-zanim='{"delay":0}'>
						<span class="icon-Brush color-primary mr-3"></span>내가 그린 그림에 내
						심리상태가 반영되어 있다.
					</h5>
					<p class="mt-3 pr-3 pr-lg-5 mb-2" data-zanim='{"delay":0.1}'>간단한
						테스트를 통해 나의 심리를 파악해보자!</p>
					<a href="${pageContext.request.contextPath}/psyPayment/artTestApp"
						class="btn btn-outline-primary">START</a>
				</div>
