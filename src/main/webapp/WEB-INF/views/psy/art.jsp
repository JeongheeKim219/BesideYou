    ...
    <body data-spy="scroll" data-target=".inner-link" data-offset="60">
        <main>
            ...
            <section>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 pr-0 pr-lg-3"  style="text-align : center;"><img class="radius-secondary" src="/assets/images/psy/art.jpg" alt="art main" /></div>
                    </div>
                    <!--/.row-->
                    ...
                    <div class="col-sm-8 col-lg-12 px-4 px-sm-3 mt-4 mt-sm-0 text-lg-x text-center" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                            ...
                            <a href="${pageContext.request.contextPath}/psy/lo/artCounselor" class="btn btn-outline-primary">START</a>
                        </div>
