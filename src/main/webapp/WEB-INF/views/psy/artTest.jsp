				...
				<section class="background-11">
					<div class="container">
						...
						<div class="row no-gutters">
							<div
								class="col-lg-12 px-5 py-6 my-lg-0 background-white radius-tr-lg-secondary radius-br-secondary radius-bl-secondary radius-bl-lg-0">
								<div class="d-flex align-items-center h-100">
									<div data-zanim-timeline="{}" data-zanim-trigger="scroll">
										<h5 data-zanim='{"delay":0}'>그림테스트 지시사항</h5>
										<p class="my-4" data-zanim='{"delay":0.1}'>${ac.question}</p>
										<h5 class="text-uppercase mt-3 fw-500 mb-3"
											data-zanim='{"delay":0.3}'>그림테스트 검사항목</h5>
						...
						<div class="row mt-6">
							<div class="col-12">
								<div
									...
									<h5>파일 첨부하기</h5>
									<form id="form"
										action="${pageContext.request.contextPath}/psy/lo/upload"
										method="post" enctype="multipart/form-data">
										<input type="hidden" name="name"
											value="${ac.counselor.member.name}"> <input
											type="hidden" name="code" value="${ac.artCounselorCode}">
