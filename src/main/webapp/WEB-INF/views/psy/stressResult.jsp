							...
							<c:choose>
								<c:when test="${total<13}">
									...
									<div class="media pt-5">
										<span class="icon-Laughing fs-5 color-warning mr-3 mt-3"
											style="transform: translateY(-1rem)"></span>
								</c:when>
								<c:when test="${total>12 and total<17}">
									<div style="text-align: center;" class="mb-6">
										<img class="radius-tr-secondary radius-tl-secondary"
											src="/assets/images/psy/stress1.jpg" alt="70gratethan"
											width=400 height=300>
									</div>
									<h5 class="text-center">총점이 높을수록 스트레스가 높아요. 지금 경도 스트레스를 받고
										있어요.</h5>
									<div class="media pt-5">
										<span class="icon-Depression fs-5 color-warning mr-3 mt-3"
											style="transform: translateY(-1rem)"></span>
								</c:when>
								<c:when test="${total>16 and total<19}">
									...
									<h5 class="text-center">총점이 높을수록 스트레스가 높아요. 지금 중등도 스트레스를
										받고 있어요. 우울증과 불안증 검사가 필요해요.</h5>
									<div class="media pt-5">
										<span class="icon-Confused fs-5 color-warning mr-3 mt-3"
											style="transform: translateY(-1rem)"></span>
								</c:when>
								<c:when test="${total>18}">
									<div style="text-align: center;" class="mb-6">
										<img class="radius-tr-secondary radius-tl-secondary"
											src="/assets/images/psy/stress3.jpg" alt="70gratethan"
											width=400 height=300>
									</div>
									<h5 class="text-center">총점이 높을수록 스트레스가 높아요. 지금 심한 스트레스를 받고
										있어요.</h5>
									<h5 class="text-center">우울증과 불안증 검사 및 정신건강 전문가와의 면담이 필요해요.</h5>
									<div class="media pt-5">
										<span class="icon-Crying fs-5 color-warning mr-3 mt-3"
											style="transform: translateY(-1rem)"></span>
								</c:when>
								<c:otherwise>
									<div style="text-align: center;" class="mb-6">
									...
									<div class="media pt-5">
										<span class="icon-Cool fs-5 color-warning mr-3 mt-3"
											style="transform: translateY(-1rem)"></span>
								</c:otherwise>
							</c:choose>
							<div class="media-body">
								<h2 class="color-primary fs-3 fs-lg-4">
									나의 스트레스 지수는<br /> <span class="color-warning">${total}
										점입니다.</span>
								</h2>
							</div>
						</div>
					...
					<div class="col-12">
						<div
							...
							<blockquote class="blockquote my-5 ml-lg-6"
								...
								<h5 class="fw-500 ml-3 mb-0">스트레스로 위로와 객관적인 조언이 필요하다면 BU 에서
									전문가에게 상담받으세요!</h5>
								<br>
								<div style="text-align: center;">
