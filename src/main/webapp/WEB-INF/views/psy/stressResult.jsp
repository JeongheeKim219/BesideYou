		                        ...
		                        <div class="col-12">
			                        <c:choose>
			                        	<c:when test="${total<13}">
			                        		...
			                        		<div class="media"><span class="icon-Laughing fs-5 color-warning mr-3 mt-3" style="transform: translateY(-1rem)"></span>
			                            	</div>
			                        	</c:when>
			                        	<c:when test="${total>12 and total<17}">
			                        		...
			                        		<div class="media"><span class="icon-Depression fs-5 color-warning mr-3 mt-3" style="transform: translateY(-1rem)"></span>
			                            	</div>
			                        	</c:when>
			                        	<c:when test="${total>16 and total<19}">
			                        		...
			                        		<div class="media"><span class="icon-Confused fs-5 color-warning mr-3 mt-3" style="transform: translateY(-1rem)"></span>
			                            	</div>
			                        	</c:when>
			                        	<c:when test="${total>18}">
			                        		...
			                        		<div class="media"><span class="icon-Crying fs-5 color-warning mr-3 mt-3" style="transform: translateY(-1rem)"></span>
			                            	</div>
			                        	</c:when>
			                        	<c:otherwise>
			                        		<div  style="text-align : center;" class="mb-6">
