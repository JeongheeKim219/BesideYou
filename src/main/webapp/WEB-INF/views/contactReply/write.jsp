...
<form name="writeForm" method="post" action="${pageContext.request.contextPath}/contactReply/insert"  >
  <input type="hidden" name="contactCode" value="${contactCode}" />
<table align="center" cellpadding="5" cellspacing="2" width="600" border="1" >

    <tr>
        <td width="1220" height="20" colspan="2" bgcolor="#3680B3">
            <p align="center"><font color="white" size="3"><b>${contactCode}부모글에  Reply 등록 </b></font></p>
        </td>
    </tr>
    ...
    <tr>
		...
		<textarea name="contactReplyContent"  rows="20" cols="60"></textarea></span></b></td>
    </tr>
