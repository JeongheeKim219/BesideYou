...
<div class="znav-white znav-container sticky-top navbar-elixir"
	...
	<div class="container">
		<nav class="navbar navbar-expand-lg"> <a
			class="navbar-brand overflow-hidden pr-3"
...
<BODY>
	...
	<div class="container">
		<h3 class="text-center fs-2 fs-md-3">문의글 등록</h3>
		<hr class="short"
		...
		<div class="col-12 mt-4">
			<div class="background-white p-5 h-100 radius-secondary">
				...
				<form name="writeForm" id="writeForm" method="post"
					action="${pageContext.request.contextPath}/contact/insert"
					...
					<div class="row">
						<div class="col-12">
							<input class="form-control background-white" type="text"
								name="contactTitle" placeholder="제목">
						</div>
						<div class="col-12 mt-4">
						...
						<div class="col-12 mt-4">
							<textarea class="form-control background-white" rows="11"
								name="contactContent" placeholder="내용"></textarea>
						</div>
						<div class="col-12 mt-4">
							<div class="row">
								<div class="col-auto">
									<button class="btn btn-md-lg btn-primary" type="submit">
										<span class="color-white fw-600">등록하기</span>
									</button>
								</div>
								<div class="col-auto">
									<button class="btn btn-md-lg btn-primary" type="reset">
