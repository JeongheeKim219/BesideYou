...
a {
	...
	<section class="background-11" style="padding-top: 70px !important">
		<div class="container">
			<h3 class="text-center fs-2 fs-md-3">1 : 1 문의</h3>
			<hr class="short"
			...
			<table align="center" border="0" cellpadding="5" cellspacing="2"
				...
				<tr>
					...
					<td bgcolor="#3680B3">
						<p align="center">
							<font color="white"><b><span style="font-size: 9pt;">카테고리</span></b></font>
						</p>
					</td>
					<td bgcolor="#3680B3">
						<p align="center">
					...
					<td bgcolor="#3680B3">
						<p align="center">
							<font color="white"><b><span style="font-size: 9pt;">처리상태</span></b></font>
						</p>
					</td>
				</tr>
				<c:choose>
					...
					<c:otherwise>
						<c:forEach items="${requestScope.pageList.content}" var="contact">
							<!-- pageList.getContent() -->
							<tr onmouseover="this.style.background='#eaeaea'"
								onmouseout="this.style.background='white'">
								<td bgcolor="">
									<p align="center">
										<span style="font-size: 9pt;"> ${contact.contactCode}</span>
									</p>
								</td>
		            		...
		            		기타
								...
								<td bgcolor="">
									<p>
										<span style="font-size: 9pt;"> <a
											href="${pageContext.request.contextPath}/contact/readUser/${contact.contactCode}">
												${contact.contactTitle} <%-- /  Reply count : <b style="color:red">${contact.replyList.size()} --%>
												</b>
										</a>
										</span>
									</p>
								...
								<td bgcolor="">
									<p align="center">
										<span style="font-size: 9pt;"> ${contact.member.id}</span>
									</p>
								</td>

								<td bgcolor="">
									<p align="center">
										<span style="font-size: 9pt;"> ${contact.contactDate}</span>
									</p>
								</td>
								...
								<td bgcolor="">
									<p align="center">
										<span style="font-size: 9pt;"> <c:choose>
												<c:when
													test="${contact.contactReply.contactReplyContent != null}">
			...
			<div align=right style="padding-top: 20px">
				<span style="font-size: 9pt;"><a
					href="${pageContext.request.contextPath}/contact/write"
					class="btn btn-primary">글쓰기</a> </span>
			</div>
		</div>
		<div style="text-align: center; padding-top: 20px;">
			...
			<c:if test="${not empty pageList.content}">
				<c:forEach begin="0" end="${pageList.totalPages-1}" var="i">
					<!-- pageList.getTotalPages()호출 (0부터 시작해서 -1) -->
					<c:choose>
						<c:when test="${pageList.number==i}">
							<a
								href="${pageContext.request.contextPath}/contact/list?nowPage=${i}"
