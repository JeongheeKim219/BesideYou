...
<BODY>
	...
	<section class="background-11" style="padding-top: 70px !important">
		<div class="container">
			<h3 class="text-center fs-2 fs-md-3">문의글 수정하기</h3>
			<hr class="short"
			...
			<div class="col-12 mt-4">
				<div class="background-white p-5 h-100 radius-secondary">
					<h5>${contact.contactCode}번 문의글 수정하기</h5>
					<form id="updateForm" method="post"
						action="${pageContext.request.contextPath}/contact/update">
						<input type="hidden" name="${_csrf.parameterName}"
							value="${_csrf.token}" />
						...
						<div class="row">
							...
							<div class="col-12 mt-4">
								<textarea class="form-control background-white" rows="11"
									name="contactContent">${requestScope.contact.contactContent}</textarea>
							</div>
							<div class="col-12 mt-4">
								<div class="row">
									<div class="col-auto">
