...
<body>
	<form name="requestForm" method="post" id="requestForm">
		...
		<c:choose>
			<c:when test="${empty requestScope.revList.content}">
				<div class="panel panel-default" style="width: 600px;">
						<!-- Default panel contents -->
						<div class="panel-heading"><b>리뷰 번호 :</b> ${revList.reviewCode}</div>
						<!-- Table -->
		...
		<%-- 	<c:otherwise>
				<c:forEach items="${requestScope.revList.content }" var="review"
					varStatus="num">
					<div class="panel panel-default" style="width: 1000px;">
						...
						<table class="table">
							<tr >
								...
								<td>상담사 번호 :<a href="${path}/review/code/${review.counselorCode.counselorCode}">${review.counselorCode.counselorCode}</a></td>
							</tr>
							<tr>
