...
<body>
	...
	<form name="requestForm" method="post" id="requestForm" vertical>
		<div align="center">
					...
					<div class="panel panel-default" style="width: 600px;">
						...
						<table class="table" align="center">
							...
							<tr>
								<td colspan="4">
									<p align="center">
										<b><span style="font-size: 12px;">등록된 리뷰가 없습니다.</span></b>
									</p>
								</td>
							</tr>
							<tr></tr>
					...
					<c:forEach items="${requestScope.revList}" var="review"
						...
						<div class="panel panel-default" style="width: 1000px;">
							...
							<table class="table">
								...
								<tr>
									<td style="border-top: hidden;" colspan="5" align="right"><input
										type="button" id="btn_${num.index}" name="btn" value="신고하기">
										<input type="hidden" id="reviewCode_${num.index}"
			...
			<a href="?page=${previous}">Previous</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
			...
			<table border="1">
				...
				<tr>
					...
					<td width="450" height="20"><b><span
							style="font-size: 9pt; margin: 2px;"> <input
								id="memberCode" size="30" value=""
				...
				<tr>
					<td width="150" height="20"
						style="vertical-align: center; margin: 2px;">신고사유 <!-- <p align="right">
							<b><span style="font-size: 9pt;vertical-align: center;">신고사유</span></b>
						</p> -->
					</td>
					<td width="450" height="20"><b><span
							style="font-size: 9pt;"> <select name="reportOption"
								id="reportOption"
								style="border: none; border-right: 0px; border-top: 0px; boder-left: 0px; boder-bottom: 0px;">
				...
				<tr>
					<td width="450" height="20" colspan="2" align="center"><b>
							<span style="font-size: 9pt;"> <input type="button"
								id="reportBtn" value=신고등록> <input type="button"
								id="backBtn" value="돌아가기">
						</span>
					</b></td>
				</tr>
			</table>
	...
	$(document).ready(function() {
		...
		$("#reportBtn").click(function() {
			...
			/* $.ajax({
				...
				data : JSON.stringify({memberCode : memberCode, reviewCode:reviewCode, reportOption:reportOption}),
				dataType :'json',
