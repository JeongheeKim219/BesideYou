			...
			<c:when test="${empty requestScope.reviewList}">
				<div class="panel panel-default" style="width: 600px;">
						...
						<table class="table" align="center">
							<tr>
								<td>회원 번호 : ${review.memberCode.memberCode}</td>
					...
					<div class="panel panel-default" style="width: 1000px;">
						...
						<table class="table">
							<tr >
								...
								<td>별점 : ${review.star}</td>
								<td>리뷰날짜: ${review.reviewDate}</td>
								<td>상담사 번호 :${review.counselorCode.counselorCode}</td>
							</tr>
							<tr>
								<td colspan="5">${review.reviewContent}</td>
							</tr>
							<tr>
								<td style="border-top: hidden;" colspan="5" align="right"><input type="button"
									id="btn_${num.index}" name="btn" value="신고하기" > <input
			...
			<table border="1">
				...
				<tr>
					...
					<td width="450" height="20"><b><span style="font-size: 9pt;">
								<input id="memberCode" size="30" value="">
				...
				<tr>
					<td width="450" height="20" colspan="2" align="center">
						...
						<input type="button" id="backBtn" value="돌아00가기">
						</span>
						</b>
					</td>
				</tr>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#reportBtn").click(function() {
			...
			console.log($('#memberCode').val() +"///"+ $('#reviewCode').val() +"///"+ $('#reportOption').val())
		    
			//var param2 = {'memberCode' : $('#memberCode').val(), 'reviewCode' : $('#reviewCode').val(), 'reportOption' : $('#reportOption').val()};
			//var param2 = {};
			//param2["memberCode"] = $('#memberCode').val();
			//param2["reviewCode"] = $('#reviewCode').val();
			//param2["reportOption"] = $('#reportOption').val();
			
			var param2 = {'memberCode' :[{'memberCode':$('#memberCode').val(),'id':''}],'reviewCode':[{'reviewCode':$('#reviewCode').val()}],'reportOption':$('#reportOption').val()};
			//$.ajax 처리{} )
			//alert(JSON.stringify({'memberCode':$('#memberCode').val(),'reviewCode':$('#reviewCode').val(),'reportOption':$('#reportOption').val()}));
			//alert(param2);
