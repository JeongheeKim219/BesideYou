						...
						<div class="d-flex align-items-center h-100">
							<div data-zanim-timeline="{}" data-zanim-trigger="scroll">
								...
								<div class="overflow-hidden" align="right">
									...
									<div class="mt-3" data-zanim='{"delay":0.2}'>${ticket.member.name}
										(${ticket.member.id})</div>
									...
									<div class="mt-3" data-zanim='{"delay":0.6}'>
										<fmt:parseDate var="refundDate" pattern="yyyy-MM-dd'T'HH:mm"
											value="${refund.refundDate}" type="both" />
								...
								<div class="overflow-hidden"
									...
									<div class="mt-3" data-zanim='{"delay":0.9}'
										style="font-weight: bold; color: navy;">환불 신청 사유</div>
								</div>
								<div class="overflow-hidden" align="right">
									<div class="mt-3" data-zanim='{"delay":0.9}'
										style="color: navy;">${refund.refundReason}</div>
								</div>
								<br>
								<hr style="height: 1px;">
									...
									<div data-zanim='{"delay":0.5}'>
										<c:choose>
											...
											<c:when test="${refund.refundState==2}">
												<span style="font-size: 18px; color: red">환불 완료</span>
											</c:when>
										</c:choose>
									</div>
								</div>
								<div class="overflow-hidden" align="right">
									<div data-zanim='{"delay":0.6}'>
										<c:choose>
											<c:when test="${ticket.ticketAmount==0}">
												<input type="button" id="delete" value="삭제하기"
													class="btn btn-outline-primary btn-xs" />&nbsp;&nbsp;
           											<a
													href="${pageContext.request.contextPath}/refund/list"><input
													type="button" id="reflist" value="목록으로"
											...
											<c:otherwise>
												<input type="button" id="process" value="환불 처리"
