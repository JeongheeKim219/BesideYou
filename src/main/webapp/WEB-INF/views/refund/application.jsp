...
<html lang="en-US">
    ...
    <body data-spy="scroll" data-target=".inner-link" data-offset="60">
        <main>
            ...
            <section>
                <div>
                    <div class="background-holder overlay" style="background-image:url(${pageContext.request.contextPath}/assets/images/background-2.jpg);background-position: center bottom;">
                    </div>
                    <!--/.background-holder-->
                    <div class="container">
                            ...
                            <div class="background-white p-5 h-100 radius-secondary">
                                ...
                                <form class="zform mt-3">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mt-4">
                                            <textarea class="form-control background-white" rows="11" placeholder="환불 신청 사유를 작성해주세요." required></textarea>
                                        </div>
                                        <div class="col-12 mt-4">
                                            <div class="row">
                                                <div class="col-auto">
