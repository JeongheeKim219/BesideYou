		...
		$("#update")
				.click(
						function() {
							...
							$("#requestForm")
									.attr("action",
											"${pageContext.request.contextPath}/faq/updateForm");
				...
				.click(
						function() {
							...
							if (result) {
								$("#requestForm")
										.attr("action",
												"${pageContext.request.contextPath}/faq/delete");
								$("#requestForm").submit();
							}
						})
...
<body>
	...
	<section class="background-11" style="padding-top: 70px !important">
		<div class="container">
			<h3 class="text-center fs-2 fs-md-3">FAQ 자세히 보기</h3>
			<hr class="short"
						...
						<div class="row">
							<div class="col-12">
								<input class="form-control background-white" type="text"
									value="${requestScope.faq.faqTitle}" readonly="readonly">
							</div>
							<div class="col-12 mt-4">
								<c:choose>
							...
							<div class="col-12 mt-4">
								<textarea class="form-control background-white" rows="11"
									readonly="readonly">${requestScope.faq.faqContent}</textarea>
							</div>
