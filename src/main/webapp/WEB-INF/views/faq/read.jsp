					...
					<div class="col-12 mt-4">
                            <div class="background-white p-5 h-100 radius-secondary">
                                ...
                                <form  id="requestForm" method="get" >
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <input class="form-control background-white" type="text" value="${requestScope.faq.faqTitle}" readonly="readonly">
                                        </div>
                                        <div class="col-12 mt-4">
                                        	<c:choose>
                                        		<c:when test="${requestScope.faq.faqCategory==0}">
		                                            <input class="form-control background-white" type="text" value="주문 결제" readonly="readonly">
                                        		</c:when>
                                        		<c:when test="${requestScope.faq.faqCategory==1}">
		                                            <input class="form-control background-white" type="text" value="상담기록" readonly="readonly">
                                        		</c:when>
                                        		<c:when test="${requestScope.faq.faqCategory==2}">
		                                            <input class="form-control background-white" type="text" value="상담사문의" readonly="readonly">
                                        		</c:when>
                                        		<c:when test="${requestScope.faq.faqCategory==3}">
		                                            <input class="form-control background-white" type="text" value="로그인" readonly="readonly">
                                        		</c:when>
                                        		<c:when test="${requestScope.faq.faqCategory==4}">
		                                            <input class="form-control background-white" type="text" value="서비스문의" readonly="readonly">
                                        		</c:when>
