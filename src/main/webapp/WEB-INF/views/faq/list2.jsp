...
#faqUl li {
	...
	<section class="background-11" style="padding-top: 70px !important">
		<div class="container">
			<h3 class="text-center fs-2 fs-md-3">FAQ</h3>
			<hr class="short"
				data-zanim='{"from":{"opacity":0,"width":0},"to":{"opacity":1,"width":"4.20873rem"},"duration":0.8}'
				data-zanim-trigger="scroll" />
			<div>
				<ul id="faqUl"`>
					<li><a href="${pageContext.request.contextPath}/faq/list0">주문,
							결제</a></li>
					...
					<c:choose>
						<c:when test="${empty requestScope.list}">
							<tr>
								<td colspan="5">
									<p align="center">
										<b><span style="font-size: 9pt;">등록된 FAQ가 없습니다.</span></b>
									</p>
								</td>
							</tr>
						</c:when>
						<c:otherwise>
							<c:forEach items="${requestScope.list}" var="list"
								...
								<tr onmouseover="this.style.background='#eaeaea'"
									...
									<td bgcolor="">
										<p align="center">
											<span style="font-size: 9pt;"> ${state.count}</span>
										</p>
									</td>
									<td bgcolor="">
										<p>
											<span style="font-size: 9pt;"> <a
												href="${pageContext.request.contextPath}/faq/read/${list.faqCode}">
													${list.faqTitle} </a>
											</span>
										</p>
									</td>
			...
			<sec:authorize access="hasRole('ROLE_ADMIN')">
				<div align=right style="padding-top: 20px">
					<span style="font-size: 9pt;"><a
						href="${pageContext.request.contextPath}/faq/write"
