	...
	<div class="col-12 mt-4">
       <div class="background-white p-5 h-100 radius-secondary">
           ...
           <form  id="updateForm" method="post" action="${pageContext.request.contextPath}/faq/update">
               ...
               <div class="row">
                   <div class="col-12">
                       <input class="form-control background-white" type="text" name="faqTitle" value="${requestScope.faq.faqTitle}" >
                   </div>
                   <div class="col-12 mt-4">
                   ...
                   <div class="col-12 mt-4">
                       <textarea class="form-control background-white" rows="11" name="faqContent">${requestScope.faq.faqContent}</textarea>
                   </div>
                   <div class="col-12 mt-4">
                       <div class="row">
                           <div class="col-auto">
