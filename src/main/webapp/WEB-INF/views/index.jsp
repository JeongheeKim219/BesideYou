					...
					<section class="py-0">
						<div>
							<div class="background-holder elixir-zanimm-scale"
								style="background-image: url(/assets/images/indexBG.jpg);"
								...
								<div class="row h-full py-8 align-items-center"
									...
									<div class="col-sm-8 col-lg-7 px-5 px-sm-3">
										<div class="overflow-hidden">
											<h1 class="fs-4 fs-md-5 zopacity" data-zanim='{"delay":0}' style="color: #FFFFFF">상담이 무서우신가요?</h1>
										</div>
										<div class="overflow-hidden" >
											<h5 data-zanim='{"delay":0}' style="color: #FFFFFF">BU는 가명으로 상담을 진행하실 수 있으며, 간단한 텍스트 상담을 지원합니다.</h5>
											<h5 data-zanim='{"delay":0}' style="color: #FFFFFF">BU의 상담사는 철저한 인증 후 등록됩니다.</h5>
										</div>
										<div class="overflow-hidden">
											<div class="zopacity" data-zanim='{"delay":0.2}'>
												<a class="btn btn-primary mr-3 mt-3" href="${pageContext.request.contextPath}/counsel/counselorList">상담사 찾기<span
							...
							<div class="container">
								<div class="row h-full py-8 align-items-center"
									...
									<div class="col-sm-8 col-lg-7 px-5 px-sm-3">
										...
										<div class="overflow-hidden">
											<div class="zopacity" data-zanim='{"delay":0.2}'>
												<a class="btn btn-primary mr-3 mt-3" href="${pageContext.request.contextPath}/psy/list">테스트하기<span
													class="fa fa-chevron-right ml-2"></span></a>
											</div>
										</div>
									</div>
